...
We are improving the ways that we reward all contributors in the Toast community. We try to be as fair as possible and use the treasury in an effective manner.
...
4. If you are a dev with solid contribution history with Toast, you can propose a regular reward for continued contributions. 

## Steps

### 1. Fill out a proposal
Go to [vote.ToastFinance.com](https://vote.ToastFinance.com) and click on the big square that says "ToastFinance.com". Once you're in, click on the [New Proposal](https://vote.ToastFinance.com/#/Toast/create) button.
...
It's important for Toast because...<BODY_OF_PROPOSAL>
...
#### Selecting Dates 
When deciding how much time to give the community to deliberate, it's important to take budget size into account.

- Any percentage based budget --> at least 10 days
- +$10k --> at least 7 days
- +$5k --> at least 4 days
...
You should go to our [Telegram](https://t.me/ToastSwap) and engage the community on why the proposal is important. 

### 3. Outcome
If the proposal passed, you'll be contacted by a member of the team, or feel free to PM anyone with the team tag on telegram to move forwards. 
